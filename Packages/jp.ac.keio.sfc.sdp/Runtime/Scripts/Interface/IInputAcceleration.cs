...
namespace GameCanvas
{
    public interface IInputAcceleration
    {
        ...
        [System.Obsolete("Use to `TryGetAccelerationEventAll` instead. Will be removed in v8.0.")]
    ...
    public interface IInputAccelerationEx : IInputAcceleration
    {
        ...
        /// </summary>
        [System.Obsolete("Use to `LastAcceleration` instead. Will be removed in v8.0.")]
        [EditorBrowsable(EditorBrowsableState.Never)]
        ...
        [System.Obsolete("Use to `TryGetAccelerationEvent` instead. Will be removed in v8.0.")]
        [EditorBrowsable(EditorBrowsableState.Never)]
