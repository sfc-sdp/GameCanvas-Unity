...
namespace GameCanvas.Editor
{
    public sealed class GcEditorResourceBuilder
    {
        ...
        const string k_GcDefaultAssetDir = "Packages/jp.ac.keio.sfc.sdp/Runtime/DefaultAssets";
        ...
        {
            const string k_DefaultFontPath = k_GcDefaultAssetDir + "/DefaultFont.ttf";
        ...
        {
            const string k_AudioMixerPath = k_GcDefaultAssetDir + "/AudioMixer.mixer";
