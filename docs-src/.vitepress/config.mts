...
// GitHub Pages はリポジトリの docs/ を配信する。
export default defineConfig({
  ...
  lastUpdated: true,
  cleanUrls: true,
  // scripts/build-docs.sh と CI は VITEPRESS_OUT_DIR で docs/ へ出す。未設定なら ./dist。
    ...
    sidebar: {
      '/guide/': [
        ...
        },
        {
          text: '移行',
          items: [
            { text: '以前の書き方から移る', link: '/guide/compatibility' }
          ]
        }
      ],
      '/api/': [
